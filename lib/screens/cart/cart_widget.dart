...
import 'package:carrented/inner_screens/product_details.dart';
import 'package:carrented/models/cart_model.dart';
import 'package:carrented/providers/products_provider.dart';
import 'package:carrented/widgets/heart_btn.dart';
...
//الملف الخاص بالعنصر الواحد ضمن العربة
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              ...
                              _quantityController(
                                fct: () {
                                  if (_quantityTextController.text == '3') {
                                    return;
                                  } else {
